...
export const buildUserSystemPrompt = (
  ...
  const assistantName =
    agent?.name || userPreferences?.botName || "SJ-chatbot";
  ...
  prompt += ` Before any table, chart, json, or code, always write one short natural language summary. 
              Do not repeat or rephrase this description after the output.`;
